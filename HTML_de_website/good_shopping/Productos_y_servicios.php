			  	...
			  	if(!isset($_SESSION['codigo_usuario_sesion'])){
					...
					echo '</div>';
		  			...
		  			echo '<div class="list-group list-group-flush" style="width:99.5%;">';
						echo '<a href="#" class="list-group-item list-group-item-action bg-light"><span><h6><i class="fas fa-shopping-bag"></i> Mis Publicaciones</h6></span></a>'; 
			...
			if (!isset($_SESSION['codigo_usuario_sesion'])) {			
				...
				echo '<div id="page-content-wrapper">';
					...
					echo '<div class="container" style="padding: 30px">';
						echo '<center><div><h5 class="col-lg-12">Mis Productos</h5></div><br>';
						...
						if ($cantidad == 1) {
							echo 'No tiene productos publicados actualmente... Empiece a <a href="publicarProducto.php">Publicar Producto</a><br><br>';
						}
						echo '</center>';
