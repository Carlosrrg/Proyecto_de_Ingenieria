...
<html lang="es" xmlns:og="http://ogp.me/ns#" xmlns:fb="https://www.facebook.com/2008/fbml" class="layout-signup ">
  ...
  <head>
      ...
      <meta property="og:image" content="img/banner_grande.png">
      <meta property="og:image:secure_url" content="img/banner_grande.png">
      ...
      <title>Registrarse  - Spotify</title>
      ...
      <link rel="stylesheet" href="css/reboot-f3fe21e4a8.css">
  ...
  <body class="page-signup  m-hn l-es page-signup is-loggedout  reboot ">
        ...
        <div id="fb-root" class=" fb_reset">
          <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
            <div>
              <iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="extra/afATJJjxKE6.html" style="border: none;">  
              </iframe>
            </div>
          </div>
          <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
                  ...
                  <div class="l-signup-header">
                      <div class="container">
                          <div class="l-box-content">
                              <a class="spotify-logo" href="index.html">
                                <img src="img/logo-registro.png">
                              </a>
                          </div>
                      </div>
                  </div>
                      ...
                      <div class="container">
                          <div class="l-box-content">
                              <section class="signup-select">  
                                    <div class="content">
                                      <a href="https://www.facebook.com/login/" class="btn btn-facebook btn-block js-signup-fb" id="select-button-signup-fb">
                              ...
                              <section class="register">
                                  <div class="content">
                                      <h2 class="center hdr-l">Regístrate con tu dirección de email</h2>
                                            
                                      <div>
                                          <fieldset>
                                              <ul>
                                                  <li class="">
                                                      <label class="sr-only required" for="register-email">
                                                        Email
                                                      </label>
                                                      <input type="email" id="txt-email" name="signup_form[email]" required="required" maxlength="100" placeholder="Email" data-msg-required="Por favor introduce tu email.">
                                                  </li>
                                                  <li class="">
                                                      <label class="sr-only required" for="register-confirm-email">
                                                        Confirmar email
                                                      </label>
                                                      <input type="email" id="txt-confirmar-email" name="signup_form[confirm_email]" required="required" maxlength="100" placeholder="Confirmar email"  data-msg-required="Por favor introduce tu email.">
                                                  </li> 
                                                  <li class="">
                                                      <label class="sr-only required" for="register-password">
                                                        Contraseña
                                                      </label>
                                                      <input type="password" id="txt-contrasena" name="signup_form[password]" required="required" autocomplete="off" maxlength="100" placeholder="Contraseña" aria-autocomplete="list">
                                                  </li>
                                                  <li class="">
                                                      <label class="sr-only required" for="register-displayname">
                                                        Nombre
                                                      </label>
                                                      <input type="text" id="txt-nombre" name="signup_form[displayname]" required="required" autocapitalize="off" autocorrect="off" autocomplete="off" maxlength="30" placeholder="¿Cómo te llamas?" data-msg-required="¿Cómo te llamas?">
                                                  </li>
                                                  <li id="li-dob" class="controls-dob" data-error-age="Lo sentimos, pero no cumples con la edad que Spotify requiere.">
                                                      <label for="register-age" class="">
                                                          Fecha de nacimiento
                                                      </label>
                                                      <div id="register-dob" class="register-dob">
                                                          <div class="controls controls-day">
                                                              <input type="number" id="txt-dia" name="signup_form[dob_day]" required="required"  placeholder="día">
                                                          </div>
                                                          ...
                                                          <div class="controls controls-year">
                                                              <input type="number" id="txt-anio" name="signup_form[dob_year]" required="required" placeholder="año">
                                                          </div>
                                                      </div>
                                                  </li>
                                                  <li id="rdb-genero" class="gender">
                                                      <label class="sr-only">Sexo</label>
                                                      <label for="rtb-maculino" class="radio control-inline">
                                                        <input type="radio" id="rtb-maculino" name="rtb-genero" required="required" value="1">
                                                        Masculino
                                                      </label>
                                                      <label for="rtb-femenino" class="radio control-inline">
                                                        <input type="radio" id="rtb-femenino" name="rtb-genero" required="required" value="2">
                                                        Femenino
                                                      </label>
                                                      <label for="rtb-ninguno" class="radio control-inline">
                                                          <input type="radio" id="rtb-ninguno" name="rtb-genero" required="required" value="3">
                                                          No binario
                                                      </label>
                                                  </li>
                                                  <li id="li-thirdparty" class="thirdparty">
                                                      <label for="register-thirdparty" class="checkbox">
                                                        <input type="checkbox" id="register-thirdparty" name="signup_form[thirdpartyemail]" class="thirdparty" value="true">
                                                  ...
                                                  <li class="li-terms-notick">
                                                        <p class="notice">
                                                          ...
                                                          <a href="#" target="">Términos y Condiciones de Uso
                                                          </a> de Spotify. <br><br>Para obtener más información sobre cómo Spotify recopila, utiliza, comparte y protege sus datos personales, lea la 
                                                          <a href="#" target="">Política de Privacidad
                                                          </a> de Spotify.
                                                        </p>
                                                  </li>   
                                              </ul>
                                          </fieldset>
                                          <button id="btn_registrarse" type="submit" class="btn btn-green btn-block">
                                            Registrarse
                                          </button> 
                                      </div>
                                      <p class="primary">
                                        ¿Ya tienes una cuenta?
                                        <a id="" data-section="login" href="iniciar_seccion.html">
                                          Iniciar sesión
                                        </a>
                                      </p>
                                      <!--<div id="prueba"></div>-->
